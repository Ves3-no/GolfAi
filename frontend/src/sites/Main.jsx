...
function MainPage({Status, setChats, Chats, ChatMessage, UserID, setChatMessage, Iron, Image, chatref}){
    return(
        ...
        <div className='flex flex-col h-[90vh] w-[100%] justify-center items-center' >
            ...
            <form onSubmit={(e)=> {(e).preventDefault();Post(Status, setChats, Chats, ChatMessage, UserID, setChatMessage)}} className='flex flex-1 p-2 flex-row w-[95%] items-center justify-center gap-4'>
